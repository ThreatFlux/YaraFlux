...
from yaraflux_mcp_server.models import User, ScanRequest, ScanResult, YaraScanResult, ErrorResponse
...
async def get_scan_result(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=f"Scan result not found: {str(e)}"
        )
