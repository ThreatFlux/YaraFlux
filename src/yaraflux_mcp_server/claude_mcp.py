...
This is a wrapper module that now uses the modular claude_mcp_tools package for
...
from .claude_mcp_tools import (
    ToolRegistry, 
    init_fastapi as init_fastapi_routes,
    register_tool
)
...
# Ensure everything from claude_mcp_tools is initialized
import yaraflux_mcp_server.claude_mcp_tools.file_tools
import yaraflux_mcp_server.claude_mcp_tools.scan_tools
import yaraflux_mcp_server.claude_mcp_tools.rule_tools
import yaraflux_mcp_server.claude_mcp_tools.storage_tools
