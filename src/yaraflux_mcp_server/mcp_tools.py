...
from yaraflux_mcp_server.models import (
    YaraRuleMetadata, YaraScanResult, ScanRequest,
    FileInfo, FileUploadRequest, FileUploadResponse, FileListResponse,
    FileStringsRequest, FileString, FileStringsResponse,
                        ...
                        for rule_file in rule_files:
                            ...
                            try:
                                ...
                                if rule_response.status_code == 200:
                                    ...
                                    logger.warning(f"Failed to download rule {rule_file}: HTTP {rule_response.status_code}")
                                    error_count += 1
                            except Exception as e:
...
def extract_strings(
    ...
    try:
        ...
        return {
            "success": False,
            "message": f"Error extracting strings: {str(e)}"
        }
