...
class YaraFluxClient:
    ...
    def create_rule(
        ...
        response = self._client.post(url, params=params, content=content, headers=headers)
        return self._handle_response(response)

    def update_rule(self, rule_name: str, content: str, source: str = "custom") -> Dict[str, Any]:
        ...
        response = self._client.put(url, params=params, content=content, headers=headers)
        return self._handle_response(response)
    ...
    def import_rules(self, url: Optional[str] = None, branch: str = "master") -> Dict[str, Any]:
    ...
    def scan_url(
        ...
        response = self._client.post(api_url, json=data, headers=self.auth_headers)
        return self._handle_response(response)
    ...
    def invoke_mcp_tool(self, tool_name: str, parameters: Dict[str, Any]) -> Any:
        ...
        response = self._client.post(url, json=parameters, headers=self.auth_headers)
        return self._handle_response(response)
