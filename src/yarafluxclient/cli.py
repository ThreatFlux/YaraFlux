...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--url", help="YaraFlux MCP Server URL", default=os.environ.get("YARAFLUX_URL", "http://localhost:8000"))
    parser.add_argument("--username", help="Username for authentication", default=os.environ.get("YARAFLUX_USERNAME"))
    parser.add_argument("--password", help="Password for authentication", default=os.environ.get("YARAFLUX_PASSWORD"))
    parser.add_argument("--token", help="JWT token for authentication", default=os.environ.get("YARAFLUX_TOKEN"))
    parser.add_argument("--timeout", help="Request timeout in seconds", type=int, default=30)
    parser.add_argument("--output", help="Output format (json, pretty)", choices=["json", "pretty"], default="pretty")
    ...
    rules_subparsers = rules_parser.add_subparsers(dest="rules_command", help="Rules command to execute")
    ...
    scan_subparsers = scan_parser.add_subparsers(dest="scan_command", help="Scan command to execute")
