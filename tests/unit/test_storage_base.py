...
class MockStorageClient(StorageClient):
    ...
    def list_files(self, page: int = 1, page_size: int = 100, sort_by: str = "uploaded_at", sort_desc: bool = True) -> Dict:
        """List files."""
    ...
    def get_hex_view(self, file_id: str, offset: int = 0, length: int = None, 
                     bytes_per_line: int = 16) -> Dict:
